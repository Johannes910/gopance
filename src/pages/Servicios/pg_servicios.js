      ...
      <main style={{ backgroundImage: `url(${bg_image})` }}>
        <div className="parentSer">
          ...
          <div className="div4Ser">
            <Card valueRestaurant="Wellness Spa" valueImg={sancochoImg} valueTitle='Spa Shiva Inu para parejas' valueParrafo="Aprovechamos lo mejor de la religión oriental para traerte la máxima relajación de Pueblito Pance." valuePrecio="$120.000" />
          </div>
        </div>
        <Footer />
      </main>
